...
Exploiting this, we have $$P_\text{ind}([r_1,r_2,r_3,\cdots]|s) = P(r_1|s)\,P(r_2|s)\,P(r_3|s)\,\cdots$$ and can can compute $\HH_\text{ind}( \SET{R} | \SET{S} )$ directly from estimates of each $P(r_i|s)$ derived from the data.
...
From an information theoretic perspective, neurons with high signal correlation have a high redundancy.
Of course, a redundant neural code is useful as a method of error correction.
Neural responses are to repeated stimuli have high-variance, indicating a large amount of noise in the system.
