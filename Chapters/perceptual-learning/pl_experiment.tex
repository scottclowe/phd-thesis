...
\begin{enumerate}
\item The trial begins with the appearance of a fixation target, on which the subject must focus their gaze.
\item A sample stimulus appears in the form of either a Gabor patch (\ac{V4} recordings) or a circular sinusoidal grating (\ac{V1} recordings) is presented at the pedestal contrast of \SI{30}{\percent} in the location corresponding to the \ac{RF} of the \ac{MEA}.
...
\item A test stimulus appears in the same location as the sample stimulus, but with a different contrast.
...
\item Two target stimuli appear above and to the right of the fixation point (which disappears).
