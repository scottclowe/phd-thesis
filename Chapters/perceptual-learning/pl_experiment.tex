...
\end{center}
\caption{
\captionemph{Number of channels recorded from for each of the monkeys and brain regions.}
}
\label{tab:nchannels}
\end{table}
...
\item A \termemph{sample stimulus} appears in the form of either a Gabor patch (\ac{V4} recordings) or a circular sinusoidal grating (\ac{V1} recordings) is presented at the pedestal contrast of \SI{30}{\percent} in the location corresponding to the \ac{RF} of the \ac{MEA}.
