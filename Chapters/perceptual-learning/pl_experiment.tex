...
%
% One small inconsistency in the experimental setup is that for \ac{M1} during the \ac{V4}-based task, the inter-stimuli wait was chosen randomly as $t_3 \in [x,y]ms$. For later experiments, including the \ac{V1} recordings for \ac{M1} and both \ac{V4} and \ac{V1} recordings for \ac{M2}, the inter-stimuli wait was fixed at $t_3 = z ms$.
