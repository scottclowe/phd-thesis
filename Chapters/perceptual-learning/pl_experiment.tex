...
For both animals, the \acp{RF} of neurons recorded from the \ac{V4} arrays were \SI[7.5]{\deg} from the centre of the visual field.
For \ac{M1}, the \ac{MEA} in \ac{V1} was \SI[4.6]{\deg} from the centre, and for \ac{M2} it was \SI[1.5]{\deg}.
In macaques, the foveal region spans \SI[\pm1]{\deg} from the centre of vision.% (Hanazono, Tsunoda, Kazato, Suzuki, & Tanifuji, 2012)
...
The experimental design has been described previously \citep[see][]{Chen2013,Chen2014}.
