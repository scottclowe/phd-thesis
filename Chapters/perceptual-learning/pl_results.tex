...
In \autoref{sec:pl_info_latency}, we noted that
Following on from, we consider how much task-pertinent information about the stimulus is maintained in the neural activity after the stimulus is removed.

The latency within the brain means the visual cortex will continue its sustained response to the stimulus for \SI{50}{\milli\second} after the stimulus is removed.
Once the input to the visual cortex catches up with reality, there is a \textit{stimulus offset} response.
Similar to the stimulus onset response seen in the rasters (\autoref{sec:pl_rasters}) and firing rate (\autoref{fig:fr_hm})
This is produced by
...
\begin{figure}[htbp]%
    \centering
    \hspace*{\fill}
    \subfloat[][\ac{M1} \ac{V1}, information post-stimulus.\label{fig:info_tp5_v1_blanco}]{%
        \includegraphics[scale=.45]{%
figs/info2/tp5/I_sessionwise_tp5_blanco_v1_chmean14_s343-359_oc0_Gclass-group-balanced_1bins_of_200ms_dr_pt_btsp20_rmvet2_rmvms2_imscn_clhot.eps}}
    \hspace*{\fill}\hspace{.2cm}\hspace*{\fill}
    \subfloat[][\ac{M2} \ac{V1}, information post-stimulus.\label{fig:info_tp5_v1_jack}]{%
        \includegraphics[scale=.45]{%
figs/info2/tp5/I_sessionwise_tp5_jack_v1_chmean20_s51-72_oc0_Gclass-group-balanced_1bins_of_200ms_dr_pt_btsp20_rmvet2_rmvms2_imscn_clhot.eps}}
    ...
    \\
    \hspace*{\fill}
    \subfloat[][\ac{M1} \ac{V1}, information pre-stimulus.\label{fig:info_tp3_v1_blanco}]{%
        \includegraphics[scale=.45]{%
figs/info2/tp5/I_sessionwise_tp3_blanco_v1_chmean14_s343-359_oc0_Gclass-group-balanced_1bins_of_200ms_dr_pt_btsp20_rmvet2_rmvms2_imscn_clhot.eps}}
    \hspace*{\fill}\hspace{.2cm}\hspace*{\fill}
    \subfloat[][\ac{M2} \ac{V1}, information pre-stimulus.\label{fig:info_tp3_v1_jack}]{%
        \includegraphics[scale=.45]{%
...
In \protect\subref{fig:info_tp3_v1_blanco} and \protect\subref{fig:info_tp3_v1_jack}, the same but for the \SI{200}{\milli\second} before the stimulus was presented, shown here for comparison purposes.
...
\begin{figure}[htbp]%
    \centering
    \hspace*{\fill}
    \subfloat[][\ac{M1} \ac{V4}, information post-stimulus.\label{fig:info_tp5_v4_blanco}]{%
        \includegraphics[scale=.45]{%
figs/info2/tp5/I_sessionwise_tp5_blanco_v4_chmean25_s307,308,311,313,314,317,318,320,321,329-341_oc0_Gclass-group-balanced_1bins_of_200ms_dr_pt_btsp20_rmvet2_rmvms2_imscn_clhot.eps}}
    \hspace*{\fill}\hspace{.2cm}\hspace*{\fill}
    \subfloat[][\ac{M2} \ac{V4}, information post-stimulus.\label{fig:info_tp5_v4_jack}]{%
        \includegraphics[scale=.45]{%
figs/info2/tp5/I_sessionwise_tp5_jack_v4_chmean18_s24,25,27-38,40-49_oc0_Gclass-group-balanced_1bins_of_200ms_dr_pt_btsp20_rmvet2_rmvms2_imscn_clhot.eps}}
    ...
    \\
    \hspace*{\fill}
    \subfloat[][\ac{M1} \ac{V4}, information pre-stimulus.\label{fig:info_tp3_v4_blanco}]{%
        \includegraphics[scale=.45]{%
figs/info2/tp5/I_sessionwise_tp3_blanco_v4_chmean25_s307,308,311,313,314,317,318,320,321,329-341_oc0_Gclass-group-balanced_1bins_of_200ms_dr_pt_btsp20_rmvet2_rmvms2_imscn_clhot.eps}}
    \hspace*{\fill}\hspace{.2cm}\hspace*{\fill}
    \subfloat[][\ac{M2} \ac{V4}, information pre-stimulus.\label{fig:info_tp3_v4_jack}]{%
        \includegraphics[scale=.45]{%
...
In \protect\subref{fig:info_tp3_v4_blanco} and \protect\subref{fig:info_tp3_v4_jack}, the same but for the \SI{200}{\milli\second} before the stimulus was presented, shown here for comparison purposes.
    \label{fig:info_tp5_v4}
}
\end{figure}

Three potential causes for this are readily apparent: bottom-up effects driven by the retina, lateral effects caused by recurrent connectivity, and top-down effects driven by feedback from higher cortical regions.

Firstly, bottom-up effects driven by the retina.
...
Such unnatural fixation will mean the same rods and cones are exposed to the test stimulus whilst it is presented, and and this will partially deplete their supply of photopigment.
...
Since our test stimulus is only presented for \SI{530}{\milli\second}, the amount of depleted photopigment will be much smaller, resulting a much less intense afterimage (potentially imperceivable).
Consequently, 
 
INCLUDE AFTERIMAGE EXAMPLE STIMULUS

Secondly, lateral effects caused by recurrent connectivity.
recurrent connectivity

Thirdly, top-down effects driven by feedback from higher cortical regions.
Having been trained extensively on this experimental task, the subject knows they must remember the \SI{425}{\milli\second} 
...
We then averaged over the stimuli with contrast higher than \SI{30}{\percent}, averaged over stimuli with contrast lower than \SI{30}{\percent}, and compared the difference between the two.
Then, we considered the firing rate difference for the start and the end of training, averaging over the first (\zonename{A}) and last (\zonename{B}) three sessions.
...
\subsection{Information about behavioural response}

We can also compute the amount of information the neural activity provides about the behavioural response of the animal.
...
\begin{figure}[htbp]%
    \centering
    \hspace*{\fill}
    \subfloat[][\ac{M1} \ac{V1}, information post-stimulus.\label{fig:respinfo_tp5_v1_blanco}]{%
        \includegraphics[scale=.45]{%
figs/info2/tp5/I_sessionwise_tp5_blanco_v1_chmean14_s343-359_oc0_Gresponse-group-balanced_1bins_of_200ms_dr_pt_btsp20_rmvet2_rmvms2_imscn_clhot.eps}}
    \hspace*{\fill}\hspace{.2cm}\hspace*{\fill}
    \subfloat[][\ac{M2} \ac{V1}, information post-stimulus.\label{fig:respinfo_tp5_v1_jack}]{%
        \includegraphics[scale=.45]{%
figs/info2/tp5/I_sessionwise_tp5_jack_v1_chmean20_s51-72_oc0_Gresponse-group-balanced_1bins_of_200ms_dr_pt_btsp20_rmvet2_rmvms2_imscn_clhot.eps}}
    ...
    \\
    \hspace*{\fill}
    \subfloat[][\ac{M1} \ac{V4}, information post-stimulus.\label{fig:respinfo_tp5_v4_blanco}]{%
        \includegraphics[scale=.45]{%
figs/info2/tp5/I_sessionwise_tp5_blanco_v4_chmean25_s307,308,311,313,314,317,318,320,321,329-341_oc0_Gresponse-group-balanced_1bins_of_200ms_dr_pt_btsp20_rmvet2_rmvms2_imscn_clhot.eps}}
    \hspace*{\fill}\hspace{.2cm}\hspace*{\fill}
    \subfloat[][\ac{M2} \ac{V4}, information post-stimulus.\label{fig:respinfo_tp5_v4_jack}]{%
        \includegraphics[scale=.45]{%
figs/info2/tp5/I_sessionwise_tp5_jack_v4_chmean18_s24,25,27-38,40-49_oc0_Gresponse-group-balanced_1bins_of_200ms_dr_pt_btsp20_rmvet2_rmvms2_imscn_clhot.eps}}
    \hspace*{\fill}
    \caption{Information about the behavioural response encoded after the stimulus is removed.
    \label{fig:respinfo_tp5_v4}
}
\end{figure}
