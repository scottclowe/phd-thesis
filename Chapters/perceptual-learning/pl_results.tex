...
% ./rcoef_2013-03-25/rcoef_sess_histallover_2013-03-25/png/rcoef_sess_histallover_v1_blanco.png}
        \includegraphics[width=0.5\linewidth]{figs/decoding/rcoef_sess_histallover_v1_blanco.pdf}
    }
    ~~
...
% ./rcoef_2013-03-25/rcoef_sess_histallover_2013-03-25/png/rcoef_sess_histallover_v1_jack.png}
        \includegraphics[width=0.5\linewidth]{figs/decoding/rcoef_sess_histallover_v1_jack.pdf}
    }
    \\
...
% ./rcoef_2013-03-25/rcoef_sess_histallover_2013-03-25/png/rcoef_sess_histallover_v4_blanco.png}
        \includegraphics[width=0.5\linewidth]{figs/decoding/rcoef_sess_histallover_v4_blanco.pdf}
    }
    ~~
...
% ./rcoef_2013-03-25/rcoef_sess_histallover_2013-03-25/png/rcoef_sess_histallover_v4_jack.png}
        \includegraphics[width=0.5\linewidth]{figs/decoding/rcoef_sess_histallover_v4_jack.pdf}
    }
...
\begin{figure}[htbp]
    \subfloat[][\label{fig:dec_b4_allp}]{
        \centering
	\includegraphics[width=0.5\linewidth]{figs/decoding/perf_v4_blanco.eps}
    }
    ~~
    \subfloat[][\label{fig:dec_j4_allp}]{
        \centering
	\includegraphics[width=0.5\linewidth]{figs/decoding/perf_v4_jack.eps}
    }
    \caption{%
...
\begin{figure}[htbp]
    \subfloat[][\label{fig:dec_b1_allp}]{
        \centering
	\includegraphics[width=0.5\linewidth]{figs/decoding/perf_v1_blanco.eps}
    }
    ~~
    \subfloat[][\label{fig:dec_j1_allp}]{
        \centering
	\includegraphics[width=0.5\linewidth]{figs/decoding/perf_v1_jack.eps}
    }
    \caption{%
...
\begin{figure}[htbp]
    \subfloat[][\label{fig:decag_b4_allp}]{
        \centering
	\includegraphics[width=0.5\linewidth]{figs/decoding/agree_v4_blanco.eps}
    }
    ~~
    \subfloat[][\label{fig:decag_j4_allp}]{
        \centering
	\includegraphics[width=0.5\linewidth]{figs/decoding/agree_v4_jack.eps}
    }
    \caption{%
    Decoding analysis for \ac{V4}.
...
\begin{figure}[htbp]
    \subfloat[][\label{fig:decag_b1_allp}]{
        \centering
	\includegraphics[width=0.5\linewidth]{figs/decoding/agree_v1_blanco.eps}
    }
    ~~
    \subfloat[][\label{fig:decag_j1_allp}]{
        \centering
	\includegraphics[width=0.5\linewidth]{figs/decoding/agree_v1_jack.eps}
    }
    \caption{%
    Decoding analysis for \ac{V1}.
    Trial-to-trial agreement between behavioural and decoding predictors.
