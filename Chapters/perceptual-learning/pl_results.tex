...
,\end{equation}
where the joint standard deviation is the root mean square of the standard deviation for two distributions,
\begin{equation}
...
We show the Gaussian kernel estimation of the distribution of information over channels (violin plot inner upper-right of \autoref{fig:info_sess_1x527_v1_blanco}, for instance) at the start (\zonename{A}) and end (\zonename{B}) of training.
