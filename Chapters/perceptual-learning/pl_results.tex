...
figs/dprime/dprime_sample_hm_hotcold_jack_v1_1_rmon2_rmvet2.eps}
    ...
    \hspace*{\fill}
    \caption{\captionemph{Change in sensitivity index, $d'$, over training sessions for \ac{V1} recordings.}
...
figs/dprime/dprime_sample_hm_hotcold_jack_v4_1_rmon2_rmvet2.eps}
    ...
    \hspace*{\fill}
    \caption{
\captionemph{Change in sensitivity index, $d'$, over training sessions for \ac{V4} recordings.}
...
As to \textemph{how} information about the stimulus could be encoded after it is removed, three potential causes for this are readily apparent: bottom-up effects driven by the retina, residual effects within the visual cortex itself, and top-down effects driven by feedback from higher cortical regions.
