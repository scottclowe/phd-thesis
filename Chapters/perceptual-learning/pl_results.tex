...
\begin{figure}[htbp]
    ...
    The data samples are shown as offset black and white triangles, whose size scales linearly with the number of samples which have the same pair of firing rate responses elicited in the two channels.
