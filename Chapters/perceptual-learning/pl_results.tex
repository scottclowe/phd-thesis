...
\begin{figure}[tbp]
    ...
    \subfloat[][\ac{M1} \ac{V1}, session \num{1}.\label{fig:pl_lin_discrim_example_v1_blanco_pre}]{%
        \includegraphics[scale=.29]{figs/decoding/lindiscrimexLCH-RG-log_cbl_v1_blanco_343_31vs44.eps}}
    \hspace*{\fill}\hspace{.2cm}\hspace*{\fill}
    \subfloat[][\ac{M2} \ac{V1}, session \num{1}.\label{fig:pl_lin_discrim_example_v1_jack_pre}]{%
        \includegraphics[scale=.29]{figs/decoding/lindiscrimexLCH-RG-log_cbl_v1_jack_51_12vs19.eps}}
    %\hspace*{\fill}
    \\
    %\hspace*{\fill}
    ...
    \subfloat[][\ac{M2} \ac{V1}, session \num{22}.\label{fig:pl_lin_discrim_example_v1_jack_post}]{%
        \includegraphics[scale=.29]{figs/decoding/lindiscrimexLCH-RG-log_cbl_v1_jack_72_12vs19.eps}}
    %\hspace*{\fill}
    \caption{
...
\begin{figure}[tbp]
    ...
    \subfloat[][\ac{M1} \ac{V4}, session \num{1}.\label{fig:pl_lin_discrim_example_v4_blanco_pre}]{%
        \includegraphics[scale=.29]{figs/decoding/lindiscrimexLCH-RG-log_cbl_v4_blanco_307_12vs51.eps}}
    \hspace*{\fill}\hspace{.2cm}\hspace*{\fill}
    \subfloat[][\ac{M2} \ac{V4}, session \num{1}.\label{fig:pl_lin_discrim_example_v4_jack_pre}]{%
        \includegraphics[scale=.29]{figs/decoding/lindiscrimexLCH-RG-log_cbl_v4_jack_24_10vs53.eps}}
    %\hspace*{\fill}
    \\
    %\hspace*{\fill}
    ...
    \subfloat[][\ac{M2} \ac{V4}, session \num{25}.\label{fig:pl_lin_discrim_example_v4_jack_post}]{%
        \includegraphics[scale=.29]{figs/decoding/lindiscrimexLCH-RG-log_cbl_v4_jack_48_10vs53.eps}}
    %\hspace*{\fill}
    \caption{
...
\vspace*{-4mm}
    ...
    \subfloat[][\ac{M1} \ac{V1}.\label{fig:dec_b1_allp}]{
        \centering
	\includegraphics[scale=.34]{figs/decoding/perf_percentage_v1_blanco_leg.eps}
    }
    \hspace*{\fill}\hspace{.2cm}\hspace*{\fill}
    \subfloat[][\ac{M2} \ac{V1}.\label{fig:dec_j1_allp}]{
        \centering
	\includegraphics[scale=.34]{figs/decoding/perf_percentage_v1_jack.eps}
    }
    \hspace*{\fill}
    \\
    \hspace*{\fill}
    \subfloat[][\ac{M1} \ac{V1}.\label{fig:dec_b1_info}]{
        \centering
	\includegraphics[scale=.34]{figs/decoding/perf_information_v1_blanco.eps}
    }
    \hspace*{\fill}\hspace{.2cm}\hspace*{\fill}
    \subfloat[][\ac{M2} \ac{V1}.\label{fig:dec_j1_info}]{
        \centering
	\includegraphics[scale=.34]{figs/decoding/perf_information_v1_jack.eps}
    }
    \hspace*{\fill}
    \caption{
...
\begin{figure}[tbp]
    ...
    \subfloat[][\ac{M1} \ac{V4}.\label{fig:dec_b4_allp}]{
        \centering
	\includegraphics[scale=.34]{figs/decoding/perf_percentage_v4_blanco_leg.eps}
    }
    \hspace*{\fill}\hspace{.2cm}\hspace*{\fill}
    \subfloat[][\ac{M2} \ac{V4}.\label{fig:dec_j4_allp}]{
        \centering
	\includegraphics[scale=.34]{figs/decoding/perf_percentage_v4_jack.eps}
    }
    \hspace*{\fill}
    \\
    \hspace*{\fill}
    \subfloat[][\ac{M1} \ac{V4}.\label{fig:dec_b4_info}]{
        \centering
	\includegraphics[scale=.34]{figs/decoding/perf_information_v4_blanco.eps}
    }
    \hspace*{\fill}\hspace{.2cm}\hspace*{\fill}
    \subfloat[][\ac{M2} \ac{V4}.\label{fig:dec_j4_info}]{
        \centering
	\includegraphics[scale=.34]{figs/decoding/perf_information_v4_jack.eps}
    }
    \hspace*{\fill}
    \caption{%
...
\begin{figure}[tbp]
    ...
    \subfloat[][\ac{M1} \ac{V1}.\label{fig:decag_b1_allp}]{
        \centering
	\includegraphics[scale=.34]{figs/decoding/agree_percentage_v1_blanco.eps}
    }
    \hspace*{\fill}\hspace{.2cm}\hspace*{\fill}
    \subfloat[][\ac{M2} \ac{V1}.\label{fig:decag_j1_allp}]{
        \centering
	\includegraphics[scale=.34]{figs/decoding/agree_percentage_v1_jack_leg.eps}
    }
    \hspace*{\fill}
    \\
    \hspace*{\fill}
    \subfloat[][\ac{M1} \ac{V1}.\label{fig:decag_b1_condinfo}]{
        \centering
	\includegraphics[scale=.34]{figs/decoding/agree_conditional-information_v1_blanco.eps}
    }
    \hspace*{\fill}\hspace{.2cm}\hspace*{\fill}
    \subfloat[][\ac{M2} \ac{V1}.\label{fig:decag_j1_condinfo}]{
        \centering
	\includegraphics[scale=.34]{figs/decoding/agree_conditional-information_v1_jack.eps}
    }
    \hspace*{\fill}
    \caption{
...
\begin{figure}[tbp]
    ...
    \subfloat[][\ac{M1} \ac{V4}.\label{fig:decag_b4_allp}]{
        \centering
	\includegraphics[scale=.34]{figs/decoding/agree_percentage_v4_blanco_leg.eps}
    }
    \hspace*{\fill}\hspace{.2cm}\hspace*{\fill}
    \subfloat[][\ac{M2} \ac{V4}.\label{fig:decag_j4_allp}]{
        \centering
	\includegraphics[scale=.34]{figs/decoding/agree_percentage_v4_jack.eps}
    }
    \hspace*{\fill}
    \\
    \hspace*{\fill}
    \subfloat[][\ac{M1} \ac{V4}.\label{fig:decag_b4_condinfo}]{
        \centering
	\includegraphics[scale=.34]{figs/decoding/agree_conditional-information_v4_blanco.eps}
    }
    \hspace*{\fill}\hspace{.2cm}\hspace*{\fill}
    \subfloat[][\ac{M2} \ac{V4}.\label{fig:decag_j4_condinfo}]{
        \centering
	\includegraphics[scale=.34]{figs/decoding/agree_conditional-information_v4_jack.eps}
    }
    \hspace*{\fill}
    \caption{
