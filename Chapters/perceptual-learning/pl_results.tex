...
Right top, violin plots showing distribution over channels of the average $d'$ in the first (\zonename{A}) and last (\zonename{B}) three sessions, with mean (solid black line) and median (dashed green line) over channels indicated.
