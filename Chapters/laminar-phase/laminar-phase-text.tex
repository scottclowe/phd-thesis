...
Similar to the above, we can also consider the redundancy between information in the power and phase across a range of frequencies.
...
We find that \autoref{fig:lam_cxfrq_powerphase_info}

\SIrange{5}{15}{Hz} phase \SIrange{10}{20}{Hz} power
