...
\begin{figure}[htbp]
    ...
    \subfloat[\ac{LFP}\label{fig:lam_phase_info_lfp}]{
        \includegraphics[scale=.45]{phaseinfo/fig3set-info-Csd-phase-straightnanmean-compzonescb-legend.png}}
    \hspace*{\fill}\hspace{.2cm}\hspace*{\fill}
    \subfloat[\ac{CSD}\label{fig:lam_phase_info_csd}]{
        \includegraphics[scale=.45]{phaseinfo/fig3set-info-Cln-phase-straightnanmean-compzonescb-legend.png}}
    \hspace*{\fill}
    \caption{
...
\begin{figure}[htbp]
    ...
    \subfloat[\label{fig:lam_phase_cxchn_info_red_bar}]{
        \includegraphics[scale=.5]{redundancy-cxschn/bndflt-barplot4_PCred-none-avg_lag=0s_paper.eps}
}
