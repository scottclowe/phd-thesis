...
\begin{figure}[bth]
    \begin{subfigure}{0.45\linewidth}
        ...
        {\includegraphics[width=\linewidth]{gfx/example_1}}
    \end{subfigure}
    \quad
    \begin{subfigure}{0.45\linewidth}
        \caption{Pan ma signo.}
        \label{fig:example-b}%
        {\includegraphics[width=\linewidth]{gfx/example_2}}
    \end{subfigure}
    \\
    \begin{subfigure}{0.45\linewidth}
        \caption{Methodicamente o uno.}
        {\includegraphics[width=\linewidth]{gfx/example_3}}
    \end{subfigure}
    \quad
    \begin{subfigure}{0.45\linewidth}
        \caption{Titulo debitas.}
        {\includegraphics[width=\linewidth]{gfx/example_4}}
    \end{subfigure}
