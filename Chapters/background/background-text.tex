...
There are known to be many types of \acp{RGC} (at least \num{17}), most of which are not well studied and poorly understood, but the three most common types are well characterised and constitute around $88\%$ of all the \acp{RGC} \citep{Nassi2009}.
...
The ventral stream also begins with \ac{V1} and \ac{V2}, but then progresses to \ac{V4} and the \acl{IT}.
...
We define this as the expected amount of information we will gain when we observe the state of the system,
\begin{align}
\HH( X )
