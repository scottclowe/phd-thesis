...
The very highest level of visual acuity is in foveola, the central part of the fovea where the cone density is greatest, which covers eccentricities less than \SI{0.5}{\degree} from the line-of-sight \citep{Hendrickson2005}.
...
The very high density of cones within the fovea, and the one-to-one correspondence of cones to \acp{RGC} exclusively within the fovea, result in a disproportionately high fraction of the visual information reaching \ac{V1} is from the fovea.%
...
The amount of cortical magnification is inversely proportional to visual eccentricity \citep{Strasburger2011}.
