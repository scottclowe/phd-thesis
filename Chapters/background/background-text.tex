...
Approximately $70\%$ of retinal cells which project to the \ac{LGN} are midget cells, making them by far the most common class of \acp{RGC}.
...
The output of midget \acp{RGC} are directed to parvocellular layers in the \ac{LGN}, which is then directed to \aclu{L4Cb} within \ac{V1} (\acs{L4Cb}).
...
Bistratified \acp{RGC} project to the koniocellular layers of \ac{LGN}, which then targets cytochrome oxidase-expressing patches (blob cells) in \acs{L2/3} of \ac{V1} (K-pathway).
