...
In order to transmit electrical signals over long distances (longer than \SI{1}{\milli\metre}), instead of making direct, analog connections with one another, neurons digitise their information as \termemph{action potentials}.
...
The sharp rise and fall of the voltage across the membrane is known as an action potential, or \textemph{spike}, and has a duration of only around \SIrange{1}{2}{\milli\second} \citealp[Chapter~1]{Dayan2001}.
...
Since there are about \num{130} million photoreceptors in the human eye, but only \num{1.5} million axons which send information from the retina to the brain \citep{Nassi2009}, the information collected from the photoreceptors must be processed.

Within the retina, rods and cones feed their outputs into bipolar cells, are also located in the retina of the eye.
...
There are three dominant types, which account for \SI{90}{\percent} \citep{Nassi2009}
...
Topological maps form across the cortex, which appears to be a self-organising mapping providing good coverage over all inputs to \ac{V1} \cite{Miikkulainen2005,Stevens2013,Wilson2015}.
...
\subsection{Rest of visual cortex}

Two streams \cite{Goodale199220,Mishkin198257}.
...
Whilst \ac{V1} responds strongly to oriented bars, \ac{V2} and \ac{V4} have been found to respond to increasingly more abstract shapes.
...
\subsection{The rest of the brain}
