...
The \acf{V1} is constituted of several layers stacked on top of each other, like a 

The primary visual cortex is sensitive to orientated bars edges at different

Classically, this was understood as simple and complex cells, however the full processing is more complicated \citep{Harris2013}

Topological maps form across the cortex, which appears to be a self-organising mapping providing good coverage over all inputs to \ac{V1} \citep{Miikkulainen2005,Stevens2013,Wilson2015}.
...
From \ac{V1}, visual information forks and progresses down two parallel streams \citep{Goodale199220,Mishkin198257}.
