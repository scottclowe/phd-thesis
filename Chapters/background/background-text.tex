...
.\end{align}
For brevity, we will use the term \textemp{information} to refer to the mutual information between two random variables throughout this thesis, instead of the self-information defined in \autoref{eq:shannon-information}.

In \autoref{eq:mutual-information}, we make use of the conditional entropy, $\HH(X | Y)$.
