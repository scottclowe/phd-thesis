...
\begin{table}[hbtp]
\caption{\small{}Durations of each section of the trials.
...
% \end{center}
% \caption{\small{}The experiment was composed of 4 stages. In this analysis, we are concerned only with the first stage.}
% \label{fig:pltask3}
% \end{figure}
