...
\subref{fig:mahist-b4}: M1 V4, channel 4, session 336; a channel and session very strongly exhibiting the monitor artifact.
\subref{fig:mahist-j4}: M2 V4, channel 41, session 31; a dataset where the artifact is not present.
\subref{fig:mahist-j1s51}: M2 V1, channel 9, session 51; data strongly presenting the monitor artifact.
\subref{fig:mahist-j1s56}: M2 V1, channel 9, session 56; data mildly showing the effect of the monitor artifact.
...
In each case the average is taken across all available channel data: \subref{fig:sessb1}~23 channels, \subref{fig:sessb4}~30 channels, \subref{fig:sessj1}~25 channels, \subref{fig:sessj4}~20 channels.
...
The neural code used in \subref{fig:b1-1x20tp4}, \subref{fig:b1-1x20tp1} is a spike count code, whilst in \subref{fig:b1-5x4tp4} and \subref{fig:b1-5x4tp1} it is a spike timing code where the \unit[20]{ms} window was subdivided into 5 bins each of \unit[4]{ms}.
In \subref{fig:b1-1x20tp4} and \subref{fig:b1-5x4tp4} the spike-train is taken from the test presentation part of the trial;
for \subref{fig:b1-1x20tp1} and \subref{fig:b1-5x4tp1} the spike-train is taken from spontaneous pre-stimulus activity.
...
% In \subref{fig:b1-1x20tp4ma}, \subref{fig:b1-1x20tp4}, and \subref{fig:b1-5x4tp4}, the spike-train is taken from the test presentation part of the trial;
% for \subref{fig:b1-1x20tp1ma}, \subref{fig:b1-1x20tp1}, and \subref{fig:b1-5x4tp1}, the spike-train is taken from spontaneous pre-stimulus activity.
% In \subref{fig:b1-1x20tp4ma} and \subref{fig:b1-1x20tp1ma} no attempt was made to remove the monitor artifact from the raw data, whilst in the rest of the panels the data was modified to counter this as described in \ref{sec:ma}.
% \subref{fig:b1-1x20tp4ma}
% \subref{fig:b1-1x20tp1ma}
% \subref{fig:b1-1x20tp4}
% \subref{fig:b1-1x20tp1}
% \subref{fig:b1-5x4tp4}
% \subref{fig:b1-5x4tp1}
}
...
Panels \subref{fig:j1-1x20tp4}--\subref{fig:j1-5x4tp1} are the same as for Fig.~\ref{fig:b1-trialwise}.
% The neural code used in \subref{fig:j1-1x20tp4ma}--\subref{fig:j1-1x20tp1} is a spike count code, whilst in \subref{fig:j1-5x4tp4}, \subref{fig:j1-5x4tp1} it is a spike timing code where the \unit[20]{ms} window was subdivided into 5 bins each of \unit[4]{ms}.
% In \subref{fig:j1-1x20tp4ma}, \subref{fig:j1-1x20tp4}, and \subref{fig:j1-5x4tp4}, the spike-train is taken from the test presentation part of the trial;
% for \subref{fig:j1-1x20tp1ma}, \subref{fig:j1-1x20tp1}, and \subref{fig:j1-5x4tp1}, the spike-train is taken from spontaneous pre-stimulus activity.
% In \subref{fig:j1-1x20tp4ma} and \subref{fig:j1-1x20tp1ma} no attempt was made to remove the monitor artifact from the raw data, whilst in the rest of the panels the data was modified to counter this as described in \ref{sec:ma}.
% \subref{fig:j1-1x20tp4ma}
% \subref{fig:j1-1x20tp1ma}
% \subref{fig:j1-1x20tp4}
% \subref{fig:j1-1x20tp1}
% \subref{fig:j1-5x4tp4}
% \subref{fig:j1-5x4tp1}
}
...
The PT bias correction method was used in all estimates of the information.
Panels \subref{fig:b4-1x20tp4}--\subref{fig:b4-5x4tp1} are the same as for Fig.~\ref{fig:b1-trialwise}.
% The neural code used in \subref{fig:b4-1x20tp4ma}--\subref{fig:b4-1x20tp1} is a spike count code, whilst in \subref{fig:b4-5x4tp4}, \subref{fig:b4-5x4tp1} it is a spike timing code where the \unit[20]{ms} window was subdivided into 5 bins each of \unit[4]{ms}.
% In \subref{fig:b4-1x20tp4ma}, \subref{fig:b4-1x20tp4}, and \subref{fig:b4-5x4tp4}, the spike-train is taken from the test presentation part of the trial;
% for \subref{fig:b4-1x20tp1ma}, \subref{fig:b4-1x20tp1}, and \subref{fig:b4-5x4tp1}, the spike-train is taken from spontaneous pre-stimulus activity.
% In \subref{fig:b4-1x20tp4ma} and \subref{fig:b4-1x20tp1ma} no attempt was made to remove the monitor artifact from the raw data, whilst in the rest of the panels the data was modified to counter this as described in \ref{sec:ma}.
% \subref{fig:b4-1x20tp4ma}
% \subref{fig:b4-1x20tp1ma}
% \subref{fig:b4-1x20tp4}
% \subref{fig:b4-1x20tp1}
% \subref{fig:b4-5x4tp4}
% \subref{fig:b4-5x4tp1}
}
...
The PT bias correction method was used in all estimates of the information.
Panels \subref{fig:j4-1x20tp4}--\subref{fig:j4-5x4tp1} are the same as for Fig.~\ref{fig:b1-trialwise}.
% The neural code used in \subref{fig:j4-1x20tp4ma}--\subref{fig:j4-1x20tp1} is a spike count code, whilst in \subref{fig:j4-5x4tp4}, \subref{fig:j4-5x4tp1} it is a spike timing code where the \unit[20]{ms} window was subdivided into 5 bins each of \unit[4]{ms}.
% In \subref{fig:j4-1x20tp4ma}, \subref{fig:j4-1x20tp4}, and \subref{fig:j4-5x4tp4}, the spike-train is taken from the test presentation part of the trial;
% for \subref{fig:j4-1x20tp1ma}, \subref{fig:j4-1x20tp1}, and \subref{fig:j4-5x4tp1}, the spike-train is taken from spontaneous pre-stimulus activity.
% In \subref{fig:j4-1x20tp4ma} and \subref{fig:j4-1x20tp1ma} no attempt was made to remove the monitor artifact from the raw data, whilst in the rest of the panels the data was modified to counter this as described in \ref{sec:ma}.
% \subref{fig:j4-1x20tp4ma}
% \subref{fig:j4-1x20tp1ma}
% \subref{fig:j4-1x20tp4}
% \subref{fig:j4-1x20tp1}
% \subref{fig:j4-5x4tp4}
% \subref{fig:j4-5x4tp1}
}
...
% Panels \subref{fig:b1-1x20cc} and \subref{fig:b1-1x20fc} are for M1, \subref{fig:b1-1x20cc} and \subref{fig:b1-1x20fc} for M2.
}
    \label{fig:v1-fvc}
\end{figure}
