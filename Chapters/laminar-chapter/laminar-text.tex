...
\begin{figure}[htbp]
\centering \includegraphics[scale=.5]{figs/tmf/tmf-v-tmf-sggig-avg-tmfres1-2Band-2Crs.eps}

\caption{%
\textit{Information about different temporal components of the stimulus.}
...
\begin{figure}[htbp]
\centering \includegraphics[scale=.5]{figs/tmf/tmf-v-spares-sggig-avg-spatmf2-2Band.eps}
%
\caption{%
\textit{Information about different spatiotemporal components.}
