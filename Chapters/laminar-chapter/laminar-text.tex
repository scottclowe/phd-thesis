...
Briefly, glycopyrrolate (\unit[0.01]{mg\dot{}{kg}^{-1}}) and ketamine (\unit[15]{mg\dot{}{kg}^{-1}}), were used previous to general anesthesia.
Induction with fentanyl (\unit[3]{mg\dot{}{kg}^{-1}}), thiopental (\unit[5]{mg\dot{}{kg}^{-1}}) and succinylcholine chloride (\unit[3]{mg\dot{}{kg}^{-1}}), animals were intubated and ventilated using a Servo Ventilator 900C (Siemens, Germany) maintaining an end-tidal CO2 of \unit[33--35]{mm Hg} and oxygen saturation above 95\%.
...
Gamma oscillations (60-170Hz) code, with substantial redundancy across the cortical depth, with some compartmentalisation of \ac{SG} and \ac{IG} activities.
...
In Fig 6, we summarise the previous results by extracting two spatial frequency bands: coarse ({\textless}0.3cpd, low-pass spatial filter) and fine ({\textgreater}1cpd, high-pass spatial filter), example traces for which are shown above Fig 6A.
