...
The agar solution placed on top of the recording access point had an NaCl concentration of \SI{9}{\mg\per\mL}, and the conductivity of this was estimated to be \SI{2.2}{\siemens\per\metre} (Kandadai, Raymond, \& Shaw, 2012).
...
The traces have been filtered within three frequency bands: \SIrange{4}{16}{Hz}, 28--44Hz and \SIrange{60}{170}{Hz}.
...
We found the low frequency \ac{CSD} bands (\SI{<40}{Hz}) contained more information about low, coarse spatial frequencies (\SI{0.1}{0.6}{cpd}), whereas the higher frequencies (\SI{>40}{Hz}) contained more information about high, fine spatial frequencies (\SI{0.6}{5.0}{cpd}) (Fig~5B).
