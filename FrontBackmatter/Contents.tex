...
%     \vspace*{8ex}
    ...
    \begin{acronym}[AUROC]
        ...
        \acro{L1}[L1]{layer 1\acroextra{ of \acs{V1}}}
        \acro{L2/3}[L2/3]{layer 2/3\acroextra{ of \acs{V1}}}
        \acro{L4}[L4]{layer 4\acroextra{ of \acs{V1}}}
        \acro{L5}[L5]{layer 5\acroextra{ of \acs{V1}}}
        \acro{L5A}[L5A]{layer 5A\acroextra{ of \acs{V1}}}
        \acro{L5B}[L5B]{layer 5B\acroextra{ of \acs{V1}}}
        \acro{L5/6}[L5/6]{layers 5 and 6\acroextra{ of \acs{V1}}}
        \acro{L6}[L6]{layer 6\acroextra{ of \acs{V1}}}
        \acro{L6A}[L6A]{layer 6A\acroextra{ of \acs{V1}}}
        \acro{L6B}[L6B]{layer 6B\acroextra{ of \acs{V1}}}
