...
\usepackage[shortcuts]{extdash} % Provides hyphenatable compound words
%
...
% Adjust headlines
% ********************************************************************
% Show chapter and section titles in header, page number in footer
\setheadsepline{0.5pt}
\lehead{\thepage\hspace*{\fill}\headmark}
\rohead{\headmark\hspace*{\fill}\thepage}
\renewcommand{\headfont}{\footnotesize\color{halfgray}}
\addtokomafont{headsepline}{\color{halfgray}}

% No footer on chapter pages
