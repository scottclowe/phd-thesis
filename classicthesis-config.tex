...
%\expandafter\def\csname ver@subfig.sty\endcsname{} % Pretend subfigure is loaded
...
\hypersetup{%
    ...
    urlcolor=webblue, linkcolor=RoyalBlue, citecolor=webgreen, %pagecolor=RoyalBlue,%
