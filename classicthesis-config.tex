...
\newcommand{\myProf}{Mark van Rossum, \textit{University of Edinburgh}.\xspace} %Institute for Adaptive and Neural Computation,
\newcommand{\myOtherProf}{Stefano Panzeri, \textit{Istituto Italiano di Technologia}.\xspace} %Center for Neuroscience and Cognitive Systems,
\newcommand{\myThirdProf}{Alex Thiele, \textit{Newcastle University}.\xspace} %Institute of Neuroscience,
